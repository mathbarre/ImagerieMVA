...
delta_s = 40;
delta_c = 0.4;
% possible colorspace args : 'rgb','opp','lms','lab','hsv'
colorspace = 'rgb';
alpha = 0.5;
nbIter=20;
...
%imwrite(resSCT, strcat('Results/',nameB,'_on_',nameA,'_eps_',num2str(epsilon),'_lambda_',num2str(lambda),'_R_',num2str(R),'.png'));
